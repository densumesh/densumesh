...
pubDate: 2026-03-24
tags: ["AI", "agents", "RAG", "filesystem", "infrastructure"]
heroImage: "https://www.mintlify.com/images/featured/how-we-built-a-virtual-filesystem-for-our-assistant.webp"
---

import BlogImage from '../../components/BlogImage.tsx';
import CostComparisonChart from '../../components/CostComparisonChart.tsx';
import GrepPipeline from '../../components/GrepPipeline.tsx';
import RbacTree from '../../components/RbacTree.tsx';
import CollapsibleCode from '../../components/CollapsibleCode.tsx';
import { codeToHtml } from 'shiki';

export const chromafsImpl = `export class ChromaFs implements IFileSystem {
...
export const grepImpl = `const chromaFilter = toChromaFilter(
...
export const chromafsImplHtml = await codeToHtml(chromafsImpl, { lang: 'tsx', theme: 'github-dark' });
export const grepImplHtml = await codeToHtml(grepImpl, { lang: 'tsx', theme: 'github-dark' });

<BlogImage
    src="https://www.mintlify.com/images/featured/how-we-built-a-virtual-filesystem-for-our-assistant.webp"
    alt="How we built a virtual filesystem for our Assistant"
...
<CostComparisonChart client:load />
...
<BlogImage
    src="https://www.mintlify.com/images/chromafs-architecture-diagram.webp"
    alt="ChromaFs architecture diagram"
    className='max-h-[600px] my-4'
    client:load
/>
...
<CollapsibleCode
  client:only="react"
  label="View the core ChromaFs implementation"
  value="chromafs-impl"
  html={chromafsImplHtml}
/>
...
<CollapsibleCode
  client:only="react"
  label="View the grep optimization implementation"
  value="grep-impl"
  html={grepImplHtml}
/>

<GrepPipeline client:load />
