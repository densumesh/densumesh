...
description: "Using a LLM-as-a-judge for hallucinations is slow and imprecise relative to simple NER. We share how we solved hallucination detection at Trieve."
pubDate: 2025-01-07
updatedDate: 2025-01-07
tags: ["AI", "NER", "hallucination-detection", "RAG", "machine-learning"]
heroImage: "https:/cdn.densumesh.dev/ner-model-blog-hero-image.png"
---
import BlogImage from '../../components/BlogImage.tsx';


<BlogImage
    src="https:/cdn.densumesh.dev/ner-model-blog-hero-image.png"
    alt="NER model detecting hallucinations"
