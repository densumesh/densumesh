...
description: "Simple FIFO queues are not viable for multi-tenant systems. I explain why fair queuing is a must and how I built Broccoli to address this issue."
pubDate: 2025-08-29
tags: ["rust", "performance", "distributed-systems", "queueing", "broccoli"]
heroImage: "https://cdn.densumesh.dev/fairness-blog-main-blog-image.png"
---

import BlogImage from '../../components/BlogImage.tsx';

<BlogImage
    src="https://cdn.densumesh.dev/broccoli-queue-blog-hero.png"
    alt="Broccoli queueing illustration"
    className='max-h-[600px] my-4'
    caption='An illustration of messages being bottlenecked.'
    client:load
/>
...
<BlogImage
    src="https://cdn.densumesh.dev/fifo-queue.png"
    alt="FIFO queue illustration"
    className="w-[700px] my-4"
    caption="In a traditional FIFO queue, smaller jobs are stuck waiting behind one massive job."
    client:load
/>
...
<BlogImage
    src="https://cdn.densumesh.dev/fair-queue.png"
    alt="Fair queue illustration"
    className="w-[700px] my-4"
    caption="Fair queueing ensures every customer gets a turn, preventing starvation."
    client:load
/>
...
<BlogImage
    src="https://cdn.densumesh.dev/fairness-algo.png"
    alt="Fairness algorithm illustration"
    className="w-[700px] my-4"
    caption="Pseudo code for fairness algorithm"
    client:load
/>
