...
description: "How one noisy customer almost broke our product and why we built Broccoli to make queues fair for everyone"
pubDate: 2025-08-29
...
What we were seeing had a name: the “noisy neighbor” problem. Basically, in multi-tenant distributed systems, one greedy tenant can starve out the rest.
...
![image](https://cdn.densumesh.dev/fifo-queue.png)  
...
![image](https://cdn.densumesh.dev/fair-queue.png)  
...
![image](https://cdn.densumesh.dev/fairness-algo.png)
...
<div className="pl-6 mt-[-15px]">
    <ul className="list-disc list-inside">
        <li>If they're already in the rotation, we're done. They'll get their turn</li>
        <li>If they're new, we add their client ID to the end of the round-robin queue</li>
    </ul>
</div>
...
<div className="pl-6 mt-[-15px]">
    <ul className="list-disc list-inside">
        <li>If their queue is empty, they naturally drop out of the rotation</li>
        <li>If they still have messages, we put their client ID back at the end of the line</li>
    </ul>
</div>
